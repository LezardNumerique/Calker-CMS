...
*/
$config['show_in_log']= array('ERROR', 'MY_MESSAGE');
...
|
*/
$config['encryption_key'] = '64552444745d4c537a253d243c6821525b3c5e2f646e2747286a674a3e';
...
|--------------------------------------------------------------------------
*/
$config['table_captcha'] 							= 'captcha';
$config['table_crypt'] 								= 'crypt';
$config['table_groups'] 							= 'groups';
$config['table_languages'] 							= 'languages';
$config['table_medias'] 							= 'medias';
$config['table_medias_types'] 						= 'medias_types';
$config['table_medias_types_sizes'] 				= 'medias_types_sizes';
$config['table_modules'] 							= 'modules';
$config['table_navigation'] 						= 'navigation';
$config['table_pages'] 								= 'pages';
$config['table_paragraphs'] 						= 'paragraphs';
$config['table_paragraphs_types'] 					= 'paragraphs_types';
$config['table_rights'] 							= 'rights';

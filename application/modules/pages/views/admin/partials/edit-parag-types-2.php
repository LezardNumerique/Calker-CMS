...
<div id="tabs">
	...
	<fieldset>
		...
		<div id="three">
			<label for="ratio_0"><?php echo $this->lang->line('label_1/0');?></label>
			<input type="radio" name="options[ratio]" id="ratio_0" class="input_radio" value="0" <?php if(isset($media['options']['ratio']) && $media['options']['ratio'] == 0 ) echo 'checked="checked"';if($post['options']['ratio'] == 0) echo 'checked="checked"';else echo 'checked="checked"';?>/>
			<label for="ratio_1"><?php echo $this->lang->line('label_100')?></label>
			<input type="radio" name="options[ratio]" id="ratio_1" class="input_radio" value="1" <?php if(isset($media['options']['ratio']) && $media['options']['ratio'] == 1 ) echo 'checked="checked"';if($post['options']['ratio'] == 1) echo 'checked="checked"';?>/>

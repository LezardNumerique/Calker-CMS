...
arrowimages: {down:['downarrowclass', BASE_URI+APPPATH+'/views/'+ADMIN_THEME+'/img/icons/down.gif', 10], right:['rightarrowclass', BASE_URI+APPPATH+'/views/'+ADMIN_THEME+'/img/icons/right.gif']},
